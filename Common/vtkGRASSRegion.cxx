...
void vtkGRASSRegion::PrintSelf(ostream& os, vtkIndent indent) {
    ...
    os << indent << "EastWestResolution3d: " << this->EastWestResolution3d << endl;
    os << indent << "NorthSouthResolution3d: " << this->NorthSouthResolution3d << endl;
    os << indent << "TopBottomResolution: " << this->TopBottomResolution << endl;
